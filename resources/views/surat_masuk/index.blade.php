...
<div align="left">
@if($count<=0)
  <h4 align="center">Tidak ada surat masuk untuk {{Session::get('jabatan')}}!</h4>
@else
    ...
    <tr>
      ...
      <td>
            ...
            <a><span class="btn btn-warning  btn-sm" style="margin: 1px;" 
              @if($p->status_dikirim=='0' AND $p->tindak_lanjut!='0' AND $p->disposisi!='0') data-target='#modalKirimSuratMasuk' data-toggle='modal'  data-id='{!! $p->id!!}' title='Kirim Surat'
              @elseif($p->tindak_lanjut=='0' AND $p->disposisi=='0') data-target='#' disabled  title='Belum Disposisi Kepala Sekolah' data-toggle='modal' 
              @else data-target='#' disabled  title='Sudah Terkirim' data-toggle='modal'

              @endif><span class="fa fa-send"></span></span></a>
            ...
            @else
              <a title="Belum dibaca" data-toggle="modal" data-target="#" data-id=""><span class="btn btn-primary  btn-sm" style="margin: 1px;"><span class="glyphicon glyphicon-ok"></span></span></a>
            @endif
      </td>
      ...
      <td>
            ...
            @if($p->sudah_dibaca=='1')
              <a title="Sudah dibaca" data-toggle="modal" data-target="#" data-id=""><span class="btn btn-success  btn-sm" style="margin: 1px;"><span class="glyphicon glyphicon-ok"></span></span></a>
            @else
              <a title="Belum dibaca" data-toggle="modal" data-target="#" data-id=""><span class="btn btn-warning  btn-sm" style="margin: 1px;"><span class="glyphicon glyphicon-ok"></span></span></a>
            @endif 
      </td>
      @else
      <td>
